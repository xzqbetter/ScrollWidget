...
public class SnapChildBottom extends ViewGroup {
    ...
    public SnapChildBottom(Context context) {
        this(context, null);
    }

    public SnapChildBottom(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public SnapChildBottom(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                mVelocity.recycle();
                mVelocity = null;
                if (mSnapParent!=null && getScrollY() < -200) {
                    isFling = false;
                    mSnapParent.scrollToTop();
